...
import { useGetProductQuery } from "../features/user/product.services";
...
const CartItem = ({ item }: Props) => {
  ...
  const { data } = useGetProductQuery(item._id);
          ...
          <div>
            ...
            <dl className="mt-0.5 space-y-px text-[10px] text-gray-600">
              <div>
                ...
                <dd className="inline">{formatCurrency(product?.price)} VND</dd>
              </div>
            </dl>
          </div>
