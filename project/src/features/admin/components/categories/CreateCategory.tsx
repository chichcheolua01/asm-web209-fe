  ...
  return (
    <>
      ...
      <form className="p-2 mt-10">
        ...
        <button
          type="submit"
          className="bg-gray-600 text-white font-semibold rounded-lg hover:bg-gray-700 shadow-mdfocus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 px-5 py-2.5"
