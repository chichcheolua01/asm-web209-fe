          ...
          >
            <div>
              <input
                ...
                name="name"
                id="name"
                className="bg-white-50 border border-white-300 text-white-900 sm:text-sm  focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-white-700 dark:border-white-600 dark:placeholder-white-400  dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Name"
            ...
            <div>
              ...
              />
              {emailValid && (
                <p className="text-red-500 text-xs">{emailValid}</p>
              )}
            </div>
            <div>
              <input
              ...
              />
              {passwordValid && (
                <p className="text-red-500 text-xs">{passwordValid}</p>
              )}
            </div>
            <div>
              <input
              ...
              {confirmPasswordValid && (
                <p className="text-red-500 text-xs">{confirmPasswordValid}</p>
              )}
            </div>
            {signupSuccess && (
