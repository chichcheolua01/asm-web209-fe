            ...
            <div className="flex shadow-md my-10">
                <div className="w-3/4 bg-white px-10 py-10">
                    <div className="flex justify-between border-b pb-8">
                        <h1 className="font-semibold text-2xl text-red-500">Your Cart</h1>
                    ...
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                        ...
                        <div className="flex justify-center w-1/5">
                            ...
                            <input className="mx-2 border text-center w-14" type="number" />
                ...
                <div id="summary" className="w-1/4 px-8 py-10">
                    ...
                    <div className="border-t mt-8">
                        ...
                        <button className="bg-red-500 font-semibold hover:bg-red-600 py-3 text-sm text-white uppercase w-full">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
